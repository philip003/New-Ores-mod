...
public class MaracujaCrop extends BlockCrops {
	private IIcon[] IconRegister;

	public MaracujaCrop() {
		this.setBlockName("maracujaCrop");
		this.setBlockTextureName(NewOres.MODID + "maracuja_stage_0");
	}

	protected Item func_149866_i() {
		return NewOres.maracujaSeed;
	}
